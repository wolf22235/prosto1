    ...
    <nav class="navbar navbar-expand-lg navbar-dark cyan fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                ...
                <li>
                    <form class="nav-link" aria-current="page" action="index.jsp">
                        <button class="button" type="submit">Home</button>
                    </form>
                </li>
                <li>
                    <form class="nav-link" aria-current="page" action="about.jsp">
                        <button class="button" type="submit">About</button>
                    </form>
                </li>
                <li>
                    <form class="nav-link" aria-current="page" action="gallery.jsp">
                        <button class="button" type="submit">Gallery</button>
                    </form>
                </li>
                <li>
                    <form class="nav-link" aria-current="page" action="blog.jsp">
                        <button class="button" type="submit">Read my blog</button>
                    </form>
                </li>
                <li>
                    <form class="nav-link" aria-current="page" action="contact.jsp">
    ...
    <div class="about-page">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <p>Welcome to my <a href="single.jsp">personal travel</a> blog, i love to travel the globe, i have been to so many beautiful places and met interesting people the world, this website is my mirror of life. </p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul>
                            ...
                            <li class="hidden">/</li>
                            <li><a href="mystories.jsp">My stories</a></li>
                            <li class="hidden">/</li>
